...
const itemVariants = cva(
  "tw-group/item [a]:hover:tw-bg-accent/50 focus-visible:tw-border-ring focus-visible:tw-ring-ring/50 [a]:tw-transition-colors tw-flex tw-flex-wrap tw-items-center tw-rounded-md  tw-text-sm  tw-transition-colors tw-duration-100 focus-visible:tw-ring-[3px]",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm2: "tw-gap-2.5 tw-px-4 tw-py-0",
      },
    },
    defaultVariants: {
      variant: "default",
